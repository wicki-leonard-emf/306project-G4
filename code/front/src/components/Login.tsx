    ...
    <div className="min-h-screen bg-gradient-to-br from-[#7f56d9] via-[#9b87f5] to-[#6941c6] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 backdrop-blur-sm">
          ...
          {/* Demo Credentials */}
          <div className="mt-6 p-4 bg-[#f9f5ff] border border-[#e9d7fe] rounded-lg">
            <p className="text-xs font-semibold text-[#6941c6] mb-2">
              🔐 Identifiants de démo
            </p>
            <div className="space-y-1">
              <p className="text-xs text-[#535862]">
                <span className="font-semibold">Utilisateur:</span> admin
              </p>
              <p className="text-xs text-[#535862]">
                <span className="font-semibold">Mot de passe:</span> admin
              </p>
            </div>
          </div>
